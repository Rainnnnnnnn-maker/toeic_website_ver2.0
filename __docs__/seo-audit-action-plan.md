...
> `README.md` および `.trae/documents/技術ドキュメント.md`（変更履歴 4.7, 2026-07-14）を精査した結果、
...
**ドキュメント更新ルール（必須)**: 上記を実装する各 PR で `README.md` と `.trae/documents/技術ドキュメント.md`（最終更新日含む）を同時更新すること。
