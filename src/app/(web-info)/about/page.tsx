    ...
    <>
      ...
      <div className="space-y-10 text-sm leading-relaxed text-black/80 dark:text-white/80">
        <section>
          ...
          <p className="mt-2">
            単語閲覧・検索・お気に入り・通常の学習と復習は、会員登録なしで無料で利用できます。未ログインのお気に入りはブラウザのローカルストレージに保存され、サーバーには送信されません。任意の Google ログインを利用すると、お気に入りと復習・連続学習の記録がサーバーに保存され、複数端末同期とマイページの復習スケジュールを利用できます。
          </p>
        </section>
