...
export const metadata: Metadata = {
  ...
  description:
    "「TOEIC重要単語」は会員登録不要・完全無料で運営しています。サーバー費用や AI・音声生成の API 利用料の一部を、Amazon ギフト券による寄付でご支援いただけます。いただいた寄付はサイトの維持・改善に使わせていただきます。",
  alternates: {
    ...
    <>
      ...
      <div className="space-y-10 text-sm leading-relaxed text-black/80 dark:text-white/80">
        <section>
          ...
          <p>
            「TOEIC重要単語」は、会員登録不要・完全無料の個人運営サービスです。サーバー費用、AI 解説の生成、ネイティブ発音音声の生成などにより、サイトを維持・運営するためのコストが日々発生しています。
          </p>
          <p className="mt-2">
