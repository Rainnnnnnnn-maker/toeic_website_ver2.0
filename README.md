...
- **Analytics Events**: GA4 tracks word-explorer searches (`words_search`), level/letter filters (`words_filter`), and detail opens (`word_detail_open`) in addition to existing favorite/share events.
