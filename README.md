...
- **Single-Grade Review Detail Flow**: In Review Mode, choosing “Not Remembered” records the failed grade once before opening the word detail and persists the next review position. The detail-page return action is labeled “次の単語へ”, so returning advances without requiring or recording a second “Remembered” grade. The regular Study Mode keeps its existing resume behavior.
